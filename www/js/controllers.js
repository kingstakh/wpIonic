...
.controller('AppCtrl', function($scope, $ionicModal, $timeout, $sce, DataLoader, $rootScope, $log) {
  ...
  $rootScope.url = 'http://www.trouidees.co.za/wp-json/wp/v2/';
  ...
  $scope.loadPost = function() {
    ...
    DataLoader.get( singlePostApi ).then(function(response) {
      ...
      $timeout( function() {
        ...
        $ionicLoading.hide();
        window.plugins.toast.show('Sorry, no data response. Please verify your connection and pull to refresh page.', 'long', 'center', function(a){}, function(b){});
    }, 8000);
    });
